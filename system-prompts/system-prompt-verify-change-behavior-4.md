# System Prompt: verify-change-behavior-4

- Source: inline

## Summary

Confirm code changes by observing app behavior.
...
- **`.claude${PATH}*verifier*/`** — if one matches your surface (CLI
...
- **`.claude${PATH}*/`** — knows how to build and launch. Use its
...
if it made you pause, it goes here. Claim${PATH} mismatch, pre-existing
