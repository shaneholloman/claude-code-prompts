# Tool Description: 9d27ce6e

- Name: SendMessage

## Summary

SendMessageTool Send messages to agent teammates and handle protocol requests… in a team.
...
- **summary**: A ${NUM}-${NUM} word preview shown in the UI
...
{
  "to": "researcher",
  "message": "Start working on task #${NUM}",
  "summary": "Assign task #${NUM} to researcher"
}
```
