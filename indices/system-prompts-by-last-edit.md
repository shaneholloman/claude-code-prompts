...
| [`system-prompt-when-to-access-memories-3.md`](../system-prompts/system-prompt-when-to-access-memories-3.md) | System Prompt: when-to-access-memories-… - Source: native-reference-match Summary System Prompt: when-to-access-memories-… - Source: inline Summary Guideline… | 409 | 2.1.118 | 2.1.136 |
| [`system-prompt-when-to-access-memories-2.md`](../system-prompts/system-prompt-when-to-access-memories-2.md) | System Prompt: when-to-access-memories-… - Source: native-reference-match Summary System Prompt: when-to-access-memories-… - Source: inline Summary Guideline… | 398 | 2.1.118 | 2.1.136 |
| [`system-prompt-stop-after-rejection.md`](../system-prompts/system-prompt-stop-after-rejection.md) | System Prompt: stop-after-rejection - Source: native-reference-match Summary System Prompt: stop-after-rejection - Source: inline Summary Stops work when the… | 271 | 2.1.118 | 2.1.136 |
| [`system-prompt-review-classification-process.md`](../system-prompts/system-prompt-review-classification-process.md) | System Prompt: review-classification-process - Source: native-reference-match Summary System Prompt: review-classification-process Summary Carefully follow t… | 188 | 2.1.118 | 2.1.136 |
...
| File | Summary | Tokens | Init | Last edit |
| --- | --- | ---: | --- | --- |
| [`tool-description-executes-given-bash-command-returns.md`](../system-prompts/tool-description-executes-given-bash-command-returns.md) | Executes a given bash command and returns its output. | 3,488 | 2.1.118 | 2.1.136 |
| [`tool-description-executes-given-bash-command-returns.md`](../system-prompts/tool-description-executes-given-bash-command-returns.md) | Executes a given bash command and returns its output. | 3,060 | 2.1.118 | 2.1.136 |
| [`tool-description-launch-new-handle-complex-multi.md`](../system-prompts/tool-description-launch-new-handle-complex-multi.md) | Launch a new agent to handle complex, multi-step tasks. | 2,251 | 2.1.118 | 2.1.136 |
| [`tool-description-launch-new-handle-complex-multi.md`](../system-prompts/tool-description-launch-new-handle-complex-multi.md) | Launch a new agent to handle complex, multi-step tasks. | 1,977 | 2.1.118 | 2.1.136 |
| [`tool-description-create-structured-task-list-3.md`](../system-prompts/tool-description-create-structured-task-list-3.md) | Tool for organizing multi-step tasks. | 878 | 2.1.118 | 2.1.136 |
...
| [`tool-description-lsp-intelligence-operations-2.md`](../system-prompts/tool-description-lsp-intelligence-operations-2.md) | Tool Description: lsp-intelligence-operations-… - Source: native-reference-match Summary Use LSP to navigate symbols, references, hover, and call hierarchy i… | 644 | 2.1.118 | 2.1.136 |
| [`tool-description-taskcreate.md`](../system-prompts/tool-description-taskcreate.md) | Tool for organizing multi-step tasks. | 580 | 2.1.118 | 2.1.136 |
| [`tool-description-lsp.md`](../system-prompts/tool-description-lsp.md) | Tool Description: lsp-intelligence-operations-… - Source: native-reference-match Summary Use LSP to navigate symbols, references, hover, and call hierarchy i… | 310 | 2.1.118 | 2.1.136 |
| [`tool-description-edit.md`](../system-prompts/tool-description-edit.md) | Tool Description: … - Source: native-prompt-markdown-tool Summary Performs exact string replacements in files. | 285 | 2.1.118 | 2.1.136 |
...
| File | Summary | Tokens | Init | Last edit |
| --- | --- | ---: | --- | --- |
| [`agent-prompt-conversation-summarization.md`](../system-prompts/agent-prompt-conversation-summarization.md) | Your task is to create a detailed summary of the conversation so far, paying close attention to the user's explicit requests and your previous actions. | 1,317 | 2.1.118 | 2.1.136 |
| [`agent-prompt-recent-message-summarization.md`](../system-prompts/agent-prompt-recent-message-summarization.md) | Summarize key points from recent conversations. | 748 | 2.1.118 | 2.1.136 |
| [`agent-prompt-quick-git-commit.md`](../system-prompts/agent-prompt-quick-git-commit.md) | Create new git commits based on current changes. | 553 | 2.1.118 | 2.1.136 |
| [`agent-prompt-memory-synthesis.md`](../system-prompts/agent-prompt-memory-synthesis.md) | Extract relevant facts for coding queries. | 488 | 2.1.118 | 2.1.136 |
| [`agent-prompt-session-title-and-branch-generation.md`](../system-prompts/agent-prompt-session-title-and-branch-generation.md) | Generate concise session titles and git branch names. | 373 | 2.1.118 | 2.1.136 |
| [`agent-prompt-auto-mode-rule-reviewer.md`](../system-prompts/agent-prompt-auto-mode-rule-reviewer.md) | Evaluate clarity and completeness of classifier rules. | 312 | 2.1.118 | 2.1.136 |
| [`agent-prompt-determine-which-memory-files-to-attach.md`](../system-prompts/agent-prompt-determine-which-memory-files-to-attach.md) | Choose useful memories for user queries. | 306 | 2.1.118 | 2.1.136 |
...
| File | Summary | Tokens | Init | Last edit |
| --- | --- | ---: | --- | --- |
| [`skill-simplify.md`](../system-prompts/skill-simplify.md) | Simplify: Code Review and Cleanup Review all changed files for reuse, quality, and efficiency. | 1,167 | 2.1.118 | 2.1.136 |
...
| [`system-reminder-plan-mode-is-active-iterative.md`](../system-prompts/system-reminder-plan-mode-is-active-iterative.md) | Restricts edits during plan mode. | 933 | 2.1.118 | 2.1.136 |
| [`system-reminder-team-communication-guidelines.md`](../system-prompts/system-reminder-team-communication-guidelines.md) | System Reminder: team-communication-guidelines - Source: native-reference-match Summary System Reminder: team-communication-guidelines - Source: inline Summa… | 271 | 2.1.118 | 2.1.136 |
| [`system-reminder-permission-denied-2.md`](../system-prompts/system-reminder-permission-denied-2.md) | Indicates a requested tool action was rejected. | 269 | 2.1.118 | 2.1.136 |
| [`system-reminder-enable-chrome-browser-automation.md`](../system-prompts/system-reminder-enable-chrome-browser-automation.md) | System Reminder: enable-chrome-browser-automation - Source: native-reference-match Summary System Reminder: enable-chrome-browser-automation - Source: inline… | 237 | 2.1.118 | 2.1.136 |
| [`system-reminder-halt-after-rejected-action.md`](../system-prompts/system-reminder-halt-after-rejected-action.md) | System Reminder: halt-after-rejected-action - Source: native-reference-match Summary System Reminder: halt-after-rejected-action - Source: inline Summary Sto… | 228 | 2.1.118 | 2.1.136 |
