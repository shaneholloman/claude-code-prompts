# System Prompt: synthesize-multi-answer

- Source: inline

## Summary

Synthesize multiple agent findings into one coherent solution for the original task.
...
# Raw Prompt Text
InputValidationError: Original task: ${EXPR_1}
