...
- Complex multi-step tasks - When a task requires ${EXPR_7} or more distinct steps or actions
- Non-trivial and complex tasks - Tasks that require careful planning or multiple operations${EXPR_8}
...
- The task can be completed in less than ${EXPR_9} trivial steps
...
- After creating tasks, use TaskUpdate to set up dependencies (blocks${EXPR_10}) if needed
${EXPR_11}- Check TaskList first to avoid creating duplicate tasks
