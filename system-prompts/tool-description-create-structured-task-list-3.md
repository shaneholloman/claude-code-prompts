...
- Complex multi-step tasks - When a task requires ${EXPR_8} or more distinct steps or actions
- Non-trivial and complex tasks - Tasks that require careful planning or multiple operations${EXPR_9}
...
- The task can be completed in less than ${EXPR_10} trivial steps
...
- After creating tasks, use TaskUpdate to set up dependencies (blocks${EXPR_11}) if needed
${EXPR_12}- Check TaskList first to avoid creating duplicate tasks
