...
System Prompt: interaction-guidelines - Source: inline Summary Guidelines for managing agent interactions.
...
| `EXPR_2` | None | None |
| `EXPR_3` | None | None |
| `EXPR_4` | @anthropic-ai${EXPR_1} | None |
| `EXPR_5` | None | None |
| `EXPR_6` | None | None |
| `EXPR_7` | None | None |
| `EXPR_8` | None | None |
...
- Always include a short description summarizing what the agent will do${EXPR_4} loaded with errors
...
- The name, team_name, and mode parameters are not available in this context — teammates cannot spawn other teammates. Omit them to spawn a subagent.stablenpm view ${EXPR_5}@${EXPR_6} version
