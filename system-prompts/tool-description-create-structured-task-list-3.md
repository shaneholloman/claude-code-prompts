...
- Complex multi-step tasks - When a task requires ${EXPR_27} or more distinct steps or actions
- Non-trivial and complex tasks - Tasks that require careful planning or multiple operations${EXPR_28}
...
- The task can be completed in less than ${EXPR_29} trivial steps
...
- After creating tasks, use TaskUpdate to set up dependencies (blocks${EXPR_30}) if needed
${EXPR_31}- Check TaskList first to avoid creating duplicate tasks
