...
- Complex multi-step tasks - When a task requires ${EXPR_30} or more distinct steps or actions
- Non-trivial and complex tasks - Tasks that require careful planning or multiple operations${EXPR_31}
...
- The task can be completed in less than ${EXPR_32} trivial steps
...
- After creating tasks, use TaskUpdate to set up dependencies (blocks${EXPR_33}) if needed
${EXPR_34}- Check TaskList first to avoid creating duplicate tasks
