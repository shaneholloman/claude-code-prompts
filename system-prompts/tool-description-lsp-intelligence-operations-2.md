...
- prepareCallHierarchy: Get call hierarchy item at a position (functions${EXPR_17})
- incomingCalls: Find all functions${EXPR_18} that call the function at a position
- outgoingCalls: Find all functions${EXPR_19} called by the function at a position

All operations require:
- filePath: The file to operate on
- line: The line number (${EXPR_20}-based, as shown in editors)
- character: The character offset (${EXPR_21}-based, as shown in editors)
