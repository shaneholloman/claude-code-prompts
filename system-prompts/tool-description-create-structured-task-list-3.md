...
- Complex multi-step tasks - When a task requires ${EXPR_18} or more distinct steps or actions
- Non-trivial and complex tasks - Tasks that require careful planning or multiple operations${EXPR_19}
...
- The task can be completed in less than ${EXPR_20} trivial steps
...
- After creating tasks, use TaskUpdate to set up dependencies (blocks${EXPR_21}) if needed
${EXPR_22}- Check TaskList first to avoid creating duplicate tasks
