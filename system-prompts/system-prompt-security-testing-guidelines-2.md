...
# Raw Prompt Text
# System Prompt: security-testing-guidelines-${EXPR_3}
...
# Raw Prompt Text
# System Prompt: security-testing-guidelines-${EXPR_4}
...
# Raw Prompt Text
# System Prompt: security-testing-guidelines-${EXPR_5}
...
- Use the `gh` CLI for GitHub operations (PRs, issues, API).${EXPR_9}
