...
- prepareCallHierarchy: Get call hierarchy item at a position (functions${EXPR_13})
- incomingCalls: Find all functions${EXPR_14} that call the function at a position
- outgoingCalls: Find all functions${EXPR_15} called by the function at a position

All operations require:
- filePath: The file to operate on
- line: The line number (${EXPR_16}-based, as shown in editors)
- character: The character offset (${EXPR_17}-based, as shown in editors)
