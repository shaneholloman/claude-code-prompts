...
- Complex multi-step tasks - When a task requires ${EXPR_28} or more distinct steps or actions
- Non-trivial and complex tasks - Tasks that require careful planning or multiple operations${EXPR_29}
...
- The task can be completed in less than ${EXPR_30} trivial steps
...
- After creating tasks, use TaskUpdate to set up dependencies (blocks${EXPR_31}) if needed
${EXPR_32}- Check TaskList first to avoid creating duplicate tasks
