...
- Complex multi-step tasks - When a task requires ${EXPR_17} or more distinct steps or actions
- Non-trivial and complex tasks - Tasks that require careful planning or multiple operations${EXPR_18}
...
- The task can be completed in less than ${EXPR_19} trivial steps
...
- After creating tasks, use TaskUpdate to set up dependencies (blocks${EXPR_20}) if needed
${EXPR_21}- Check TaskList first to avoid creating duplicate tasks
