# System Prompt: update-session-notes-file-2

- Source: inline

## Summary

Directs editing the session notes file while preserving structure and excluding meta instructions.

## Placeholder Hints (source-backed)

| Expression | Hint | Reference |
| --- | --- | --- |
| `notesPath` | path to the session notes file | None |
| `currentNotes` | current notes file contents | None |
