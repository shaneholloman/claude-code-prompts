...
- Complex multi-step tasks - When a task requires ${EXPR_16} or more distinct steps or actions
- Non-trivial and complex tasks - Tasks that require careful planning or multiple operations${EXPR_17}
...
- The task can be completed in less than ${EXPR_18} trivial steps
...
- After creating tasks, use TaskUpdate to set up dependencies (blocks${EXPR_19}) if needed
${EXPR_20}- Check TaskList first to avoid creating duplicate tasks
