# System Prompt: run-bash-commands-safely

- Source: inline

## Summary

Run a bash command with directory checks, quoting rules, and configurable timeout.
...
Usage notes:
 ...
 - If you _still_ need to run `grep`, STOP. ALWAYS USE ripgrep at `rg` first, which all ${EXPR_4} users have pre-installed.
