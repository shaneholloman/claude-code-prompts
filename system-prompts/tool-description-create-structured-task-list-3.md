...
- Complex multi-step tasks - When a task requires ${EXPR_24} or more distinct steps or actions
- Non-trivial and complex tasks - Tasks that require careful planning or multiple operations${EXPR_25}
...
- The task can be completed in less than ${EXPR_26} trivial steps
...
- After creating tasks, use TaskUpdate to set up dependencies (blocks${EXPR_27}) if needed
${EXPR_28}- Check TaskList first to avoid creating duplicate tasks
