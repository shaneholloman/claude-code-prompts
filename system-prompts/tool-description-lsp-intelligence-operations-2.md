...
- prepareCallHierarchy: Get call hierarchy item at a position (functions${EXPR_5})
- incomingCalls: Find all functions${EXPR_6} that call the function at a position
- outgoingCalls: Find all functions${EXPR_7} called by the function at a position

All operations require:
- filePath: The file to operate on
- line: The line number (${EXPR_8}-based, as shown in editors)
- character: The character offset (${EXPR_9}-based, as shown in editors)
