...
- Complex multi-step tasks - When a task requires ${EXPR_11} or more distinct steps or actions
- Non-trivial and complex tasks - Tasks that require careful planning or multiple operations${EXPR_12}
...
- The task can be completed in less than ${EXPR_13} trivial steps
...
- After creating tasks, use TaskUpdate to set up dependencies (blocks${EXPR_14}) if needed
${EXPR_15}- Check TaskList first to avoid creating duplicate tasks
