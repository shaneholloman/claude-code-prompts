...
- Complex multi-step tasks - When a task requires ${EXPR_14} or more distinct steps or actions
- Non-trivial and complex tasks - Tasks that require careful planning or multiple operations${EXPR_15}
...
- The task can be completed in less than ${EXPR_16} trivial steps
...
- After creating tasks, use TaskUpdate to set up dependencies (blocks${EXPR_17}) if needed
${EXPR_18}- Check TaskList first to avoid creating duplicate tasks
