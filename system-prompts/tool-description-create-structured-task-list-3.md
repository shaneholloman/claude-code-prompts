...
- Complex multi-step tasks - When a task requires ${EXPR_29} or more distinct steps or actions
- Non-trivial and complex tasks - Tasks that require careful planning or multiple operations${EXPR_30}
...
- The task can be completed in less than ${EXPR_31} trivial steps
...
- After creating tasks, use TaskUpdate to set up dependencies (blocks${EXPR_32}) if needed
${EXPR_33}- Check TaskList first to avoid creating duplicate tasks
