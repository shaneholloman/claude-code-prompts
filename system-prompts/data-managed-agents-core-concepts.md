# System Prompt: data-managed-agents-core-concepts

- Source: native-reference-match

## Summary

Managed Agents — Core Concepts Architecture Managed Agents is built around four core concepts: | Concept | Endpoint | What it is | |---|---|---| | **Agent**…
...
These are ops${PATH} calls — typically made from a terminal, not application code. From the shell (see `shared${PATH}`):
