...
- Complex multi-step tasks - When a task requires ${EXPR_6} or more distinct steps or actions
- Non-trivial and complex tasks - Tasks that require careful planning or multiple operations${EXPR_7}
...
- The task can be completed in less than ${EXPR_8} trivial steps
...
- After creating tasks, use TaskUpdate to set up dependencies (blocks${EXPR_9}) if needed
${EXPR_10}- Check TaskList first to avoid creating duplicate tasks
