# System Prompt: managed-agents-client-patterns

- Source: inline

## Summary

Patterns for driving Managed Agent sessions with SDK examples.
...
## ${NUM}. Keep credentials host-side via custom tools
