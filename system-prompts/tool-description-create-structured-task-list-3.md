...
- Complex multi-step tasks - When a task requires ${EXPR_10} or more distinct steps or actions
- Non-trivial and complex tasks - Tasks that require careful planning or multiple operations${EXPR_11}
...
- The task can be completed in less than ${EXPR_12} trivial steps
...
- After creating tasks, use TaskUpdate to set up dependencies (blocks${EXPR_13}) if needed
${EXPR_14}- Check TaskList first to avoid creating duplicate tasks
