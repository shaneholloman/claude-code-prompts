...
- Complex multi-step tasks - When a task requires ${EXPR_31} or more distinct steps or actions
- Non-trivial and complex tasks - Tasks that require careful planning or multiple operations${EXPR_32}
...
- The task can be completed in less than ${EXPR_33} trivial steps
...
- After creating tasks, use TaskUpdate to set up dependencies (blocks${EXPR_34}) if needed
${EXPR_35}- Check TaskList first to avoid creating duplicate tasks
