# System Data Block: e920ba79

- Source: inline

## Summary

Claude API — cURL / Raw HTTP Use these examples when the user needs raw HTTP requests or is working in a language without an official SDK.
