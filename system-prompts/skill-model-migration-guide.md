# Skill: model-migration-guide

- Source: native-reference-match

## Summary

Model Migration Guide > **If you arrived via `… migrate`:** this is the right file.
...
> **If you arrived via `${PATH} migrate`:** this is the right file. Execute the steps below in order — do not summarize them back to the user. Start with Step ${NUM} (confirm scope) before touching any file.
