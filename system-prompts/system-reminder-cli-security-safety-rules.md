# System Reminder: cli-security-safety-rules
...
IMPORTANT: Always use the ${EXPR_18: 'TodoWrite'} tool to plan and track tasks throughout the conversation.
