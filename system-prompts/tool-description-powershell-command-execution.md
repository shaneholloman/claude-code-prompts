# Tool Prompt: powershell-command-execution
...
${EXPR_5}  - Avoid using PowerShell to run commands that have dedicated tools, unless explicitly instructed:
