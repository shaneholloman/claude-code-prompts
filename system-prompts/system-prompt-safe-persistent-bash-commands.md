# System Prompt: safe-persistent-bash-commands

- Source: inline

## Summary

Run terminal commands in persistent bash with safety checks, quoting, and directory validation.
...
${NUM}. \\.\pipe\claude-mcp-browser-bridge-default run the following commands:
...
${NUM}. \\.\pipe\claude-mcp-browser-bridge-default run the following commands in parallel:
