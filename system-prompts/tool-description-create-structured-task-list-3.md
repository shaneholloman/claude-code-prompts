...
- Complex multi-step tasks - When a task requires ${EXPR_22} or more distinct steps or actions
- Non-trivial and complex tasks - Tasks that require careful planning or multiple operations${EXPR_23}
...
- The task can be completed in less than ${EXPR_24} trivial steps
...
- After creating tasks, use TaskUpdate to set up dependencies (blocks${EXPR_25}) if needed
${EXPR_26}- Check TaskList first to avoid creating duplicate tasks
