...
- Complex multi-step tasks - When a task requires ${EXPR_33} or more distinct steps or actions
- Non-trivial and complex tasks - Tasks that require careful planning or multiple operations${EXPR_34}
...
- The task can be completed in less than ${EXPR_35} trivial steps
...
- After creating tasks, use TaskUpdate to set up dependencies (blocks${EXPR_36}) if needed
${EXPR_37}- Check TaskList first to avoid creating duplicate tasks
