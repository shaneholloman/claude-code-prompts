...
- Complex multi-step tasks - When a task requires ${EXPR_15} or more distinct steps or actions
- Non-trivial and complex tasks - Tasks that require careful planning or multiple operations${EXPR_16}
...
- The task can be completed in less than ${EXPR_17} trivial steps
...
- After creating tasks, use TaskUpdate to set up dependencies (blocks${EXPR_18}) if needed
${EXPR_19}- Check TaskList first to avoid creating duplicate tasks
