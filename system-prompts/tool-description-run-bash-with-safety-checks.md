...
| --- | --- | --- |
| `EXPR_1` | comma-separated list (17 items; e.g. alias, curl, curlie, …) | [system-prompt-secure-persistent-bash-execution.md](system-prompt-secure-persistent-bash-execution.md) |
| `EXPR_2` | 30000 | None |
