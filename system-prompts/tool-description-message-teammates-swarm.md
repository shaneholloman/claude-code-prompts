# Tool Description: message-teammates-swarm

- Name: SendMessage

## Summary

Sends direct or broadcast messages to teammates using a defined swarm messaging protocol.

# Raw Prompt Text
# SendMessageTool

Send messages to teammates and handle protocol requests${PATH} in a swarm.
