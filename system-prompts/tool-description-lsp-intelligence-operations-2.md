...
- prepareCallHierarchy: Get call hierarchy item at a position (functions${EXPR_4})
- incomingCalls: Find all functions${EXPR_5} that call the function at a position
- outgoingCalls: Find all functions${EXPR_6} called by the function at a position

All operations require:
- filePath: The file to operate on
- line: The line number (${EXPR_7}-based, as shown in editors)
- character: The character offset (${EXPR_8}-based, as shown in editors)
