...
You can use the following tools without requiring user approval: ${EXPR_7}
...
IMPORTANT: Always use the ${EXPR_8: 'TodoWrite'} tool to plan and track tasks throughout the conversation.
