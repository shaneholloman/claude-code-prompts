...
- prepareCallHierarchy: Get call hierarchy item at a position (functions${EXPR_12})
- incomingCalls: Find all functions${EXPR_13} that call the function at a position
- outgoingCalls: Find all functions${EXPR_14} called by the function at a position

All operations require:
- filePath: The file to operate on
- line: The line number (${EXPR_15}-based, as shown in editors)
- character: The character offset (${EXPR_16}-based, as shown in editors)
