...
System Data Block: finish-plan-with-provided-answers - Source: native-reference-match Summary System Prompt: finish-plan-with-provided-answers - Source: inli…
...
Complete the plan using the user's provided information.
...
${EXPR_1}
Validating ${EXPR_2} manifest: ${EXPR_3}
