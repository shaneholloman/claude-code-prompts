# System Prompt: data-message-batches-api-reference-python

- Source: native-reference-match

## Summary

Message Batches API — Python The Batches API (`POST …`) processes Messages API requests asynchronously at …% of standard prices.
...
```python
for batch in client.messages.batches.list(limit=${NUM}):
