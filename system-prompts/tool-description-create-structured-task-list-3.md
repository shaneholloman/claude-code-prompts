...
- Complex multi-step tasks - When a task requires ${EXPR_12} or more distinct steps or actions
- Non-trivial and complex tasks - Tasks that require careful planning or multiple operations${EXPR_13}
...
- The task can be completed in less than ${EXPR_14} trivial steps
...
- After creating tasks, use TaskUpdate to set up dependencies (blocks${EXPR_15}) if needed
${EXPR_16}- Check TaskList first to avoid creating duplicate tasks
