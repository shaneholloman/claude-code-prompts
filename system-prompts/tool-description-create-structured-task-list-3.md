...
- Complex multi-step tasks - When a task requires ${EXPR_13} or more distinct steps or actions
- Non-trivial and complex tasks - Tasks that require careful planning or multiple operations${EXPR_14}
...
- The task can be completed in less than ${EXPR_15} trivial steps
...
- After creating tasks, use TaskUpdate to set up dependencies (blocks${EXPR_16}) if needed
${EXPR_17}- Check TaskList first to avoid creating duplicate tasks
