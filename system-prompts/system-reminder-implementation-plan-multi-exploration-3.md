...
Instructions:
${EXPR_1}. Use the Task tool to spawn parallel agents to explore different aspects of the codebase simultaneously:
...
${EXPR_2}. Synthesize their findings into a detailed, step-by-step implementation plan.

${EXPR_3}. Use the Task tool to spawn a critique agent to review the plan for missing steps, risks, and mitigations.

${EXPR_4}. Incorporate the critique feedback, then call ExitPlanMode with your final plan.

${EXPR_5}. After ExitPlanMode returns:
...
- Ordered list of files to create${EXPR_6} with specific changes
