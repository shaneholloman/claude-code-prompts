...
- Complex multi-step tasks - When a task requires ${EXPR_23} or more distinct steps or actions
- Non-trivial and complex tasks - Tasks that require careful planning or multiple operations${EXPR_24}
...
- The task can be completed in less than ${EXPR_25} trivial steps
...
- After creating tasks, use TaskUpdate to set up dependencies (blocks${EXPR_26}) if needed
${EXPR_27}- Check TaskList first to avoid creating duplicate tasks
