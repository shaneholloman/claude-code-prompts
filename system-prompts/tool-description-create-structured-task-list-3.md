...
- Complex multi-step tasks - When a task requires ${EXPR_32} or more distinct steps or actions
- Non-trivial and complex tasks - Tasks that require careful planning or multiple operations${EXPR_33}
...
- The task can be completed in less than ${EXPR_34} trivial steps
...
- After creating tasks, use TaskUpdate to set up dependencies (blocks${EXPR_35}) if needed
${EXPR_36}- Check TaskList first to avoid creating duplicate tasks
