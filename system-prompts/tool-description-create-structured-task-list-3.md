...
- Complex multi-step tasks - When a task requires ${EXPR_9} or more distinct steps or actions
- Non-trivial and complex tasks - Tasks that require careful planning or multiple operations${EXPR_10}
...
- The task can be completed in less than ${EXPR_11} trivial steps
...
- After creating tasks, use TaskUpdate to set up dependencies (blocks${EXPR_12}) if needed
${EXPR_13}- Check TaskList first to avoid creating duplicate tasks
